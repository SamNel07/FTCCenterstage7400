...
public class RedFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence Left = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(5)
                .lineToSplineHeading(new Pose2d(52.5, -38,Math.toRadians(170)))
                .waitSeconds(1)
                ...
                .waitSeconds(2)
                //.forward(5)
                .lineToSplineHeading(new Pose2d(47, -38,Math.toRadians(170)))
        ...
        TrajectorySequence Center = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(0, -13, Math.toRadians(180)))
                .waitSeconds(5)
        ...
        TrajectorySequence Right = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(5)
                .lineToSplineHeading(new Pose2d(50.9, -51.5,Math.toRadians(170)))
                .waitSeconds(1)
                .addTemporalMarker(() -> pl.setPosition(0.5))
                .waitSeconds(0.3)
                .addTemporalMarker(() -> pl.setPosition(1))
                .waitSeconds(2)
                //.forward(5)
                .lineToSplineHeading(new Pose2d(45, -51.5,Math.toRadians(170)))
                .addTemporalMarker(() -> pl.setPosition(0))
                .waitSeconds(2)
                //.strafeRight(14)
