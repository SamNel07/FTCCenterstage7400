...
@Autonomous(group = "Blue", name = "BlueFarJustPurple")
public class BlueFarJustPurple extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence Left = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(5)
                .lineToSplineHeading(new Pose2d(50.9, 52.2,Math.toRadians(185)))
                .waitSeconds(1)
        ...
        TrajectorySequence Center = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(0, 9, Math.toRadians(180)))
                .waitSeconds(5)
                .lineToLinearHeading(new Pose2d(40, 11, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(50, 48.5, Math.toRadians(180)))
                .waitSeconds(1)
                .addTemporalMarker(() -> pl.setPosition(0.5))
                .waitSeconds(0.3)
                .addTemporalMarker(() -> pl.setPosition(1))
        ...
        TrajectorySequence Right = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(5)
                .lineToSplineHeading(new Pose2d(52, 36,Math.toRadians(190)))
                .waitSeconds(1)
                .addTemporalMarker(() -> pl.setPosition(0.5))
                .waitSeconds(0.3)
                .addTemporalMarker(() -> pl.setPosition(1))
                .waitSeconds(2)
                //.forward(5)
                .lineToSplineHeading(new Pose2d(47, 35,Math.toRadians(190)))
                .addTemporalMarker(() -> pl.setPosition(0))
                .waitSeconds(2)
                //.strafeRight(14)
